...
CREATE TABLE platform_settings (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  commission_percentage VARCHAR(5) NOT NULL DEFAULT '5',
  minimum_payout_amount VARCHAR(10) NOT NULL DEFAULT '50',
...
INSERT INTO platform_settings (commission_percentage, minimum_payout_amount) 
VALUES ('5', '50');
...
-- Allow public product creation (vendors can create products)
...
-- Orders are viewable by buyer and vendor
CREATE POLICY "Orders are viewable by buyer and vendor" ON orders
...
-- Vendor support requests are creatable by vendors
CREATE POLICY "Vendor support requests are creatable by vendors" ON vendor_support_requests
  FOR INSERT TO public WITH CHECK (true);
